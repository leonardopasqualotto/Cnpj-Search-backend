...
public class Socio {
    ...
    @ManyToOne
    @JoinColumn(name = "identificador_socio", referencedColumnName = "codigo")
    private IdentificadorSocio identificador_socio;
    ...
    @ManyToOne
    @JoinColumn(name = "faixa_etaria", referencedColumnName = "codigo")
